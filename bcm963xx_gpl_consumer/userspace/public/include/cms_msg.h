...
#endif
#if defined(AEI_VDSL_DETECT_WAN_SERVICE) || defined(SUPPORT_GPL_UNDEFINED)
...
#endif
#if defined(SUPPORT_GPL_UNDEFINED) || defined(SUPPORT_GPL_UNDEFINED)
...
#endif
#if defined(SUPPORT_GPL_UNDEFINED)
   CMS_MSG_XXX_DETECT_WAN_SERVICE                   = 0x10002672,
#endif
...
#endif
   CMS_MSG_WLAN_LINK_STATUS_CHANGED     = 0x10002675, /**<APSTA link event to ssk to update Wifi Wan status */
   CMS_MSG_WIFI_LINK_UP                 = 0x1000267A, /**< LAN side Wifi SSID link is up */
   CMS_MSG_WIFI_LINK_DOWN               = 0x1000267B, /**< LAN side Wifi SSID link is down */

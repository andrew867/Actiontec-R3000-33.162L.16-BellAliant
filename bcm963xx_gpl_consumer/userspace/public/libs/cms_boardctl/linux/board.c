...
#ifdef SUPPORT_GPL_UNDEFINED
product_info pinfo[1] ={{"V1000H","V1000H","V1000H",CMS_RELEASE_VERSION2,"/etc/default2.cfg","/webs/perm2.txt",2}};
#else
#if defined(AEI_63168_CHIP) && defined(AEI_CONFIG_JFFS)
product_info pinfo[2] ={{"T2200H","T2200H","T2200H",CMS_RELEASE_VERSION,"/etc/default.cfg","/webs/perm.txt",0 },{"T1200H","T1200H","T1200H",CMS_RELEASE_VERSION2,"/etc/default2.cfg","/webs/perm2.txt",2}};
#else
product_info pinfo[2] ={{"V2000H","V2000H","V2000H",CMS_RELEASE_VERSION,"/etc/default.cfg","/webs/perm.txt",0 },{"V1000H","V1000H","V1000H",CMS_RELEASE_VERSION2,"/etc/default2.cfg","/webs/perm2.txt",2}};
#endif
#endif

...
#endif
#ifdef AEI_VDSL_CUSTOMER_DHCP_OPTION128
 ...
 *   
 * Description: For XXX, if LAN Device is STB and hostname is NULL, we will set STB Default 
...
void AEI_DefaultSTBHostName(struct dhcpMessage *packet , struct dhcpOfferedAddr *lease)
{
    ...
    if (hostname == NULL)
    {
        ...
        strlcpy(lease->hostname, hostname, sizeof(lease->hostname));
}
#endif

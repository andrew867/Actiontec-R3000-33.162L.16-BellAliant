...
#if defined(AEI_QTN_RELOAD)
u32 aei_bcm63xx_pcie_reinit_port = 0; 
#endif
...
#if defined(AEI_QTN_RELOAD)
            if(aei_bcm63xx_pcie_reinit_port > 0 && aei_bcm63xx_pcie_reinit_port != (i+1) ){
                continue;
            }
#endif
...
#if defined(AEI_QTN_RELOAD)
EXPORT_SYMBOL(aei_bcm63xx_pcie_reinit_port);
#endif

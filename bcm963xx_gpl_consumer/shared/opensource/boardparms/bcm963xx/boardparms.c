...
#if defined(AEI_VDSL_CUSTOMER_NCS) || defined(AEI_VDSL_BCMSDK)
bp_elem_t * g_BoardParms[] = {g_C1000A,g_C2000A,g_R2200H,g_V2200H,g_T2200H,g_T1200H,g_V2200M,g_FV2200,g_FV2210,g_C1000B,g_FV2250, 
...
//  {bp_usGpioLedReserved,       .u.us = BP_SERIAL_GPIO_10_AH},  // placeholder for voip
  ...
  {bp_usWanEthSpeedLed100,     .u.us = BP_GPIO_20_AL},
  {bp_usWanEthSpeedLed1000,    .u.us = BP_GPIO_21_AL},
  {bp_usWanEthLinkLed,         .u.us = BP_GPIO_22_AL},
#endif
  {bp_usGphyBaseAddress,       .u.us = BCM963138_PHY_BASE},  // use phy addressses on SF2 with base address 0x8
  {bp_ucPhyType0,              .u.uc = BP_ENET_NO_PHY}, // Runner
  {bp_usConfigType,            .u.us = BP_ENET_CONFIG_MMAP},
...
bp_elem_t * g_BoardParms[] = {g_bcm963138sv, g_bcm963138dvt, g_bcm963138ref, g_bcm963138dvt_bmu, g_bcm963138ref_moca, g_bcm963138ref_bmu, g_bcm963138ref_lte, g_bcm963138ref_plc, 
    g_bcm963138ref_p402, g_bcm963138ref_p402_plc, g_bcm963138ref_p502, g_bcm963138bmu_p202, g_bcm963138lte_p302, g_bcm963138ref_p502_plc, g_R3000, g_bcm963138dvt_p300, g_bcm963138ref_p502_moca, g_bcm963138ref_p502_bhr, 0};
#else
bp_elem_t * g_BoardParms[] = {g_bcm963138sv, g_bcm963138dvt, g_bcm963138ref, g_bcm963138dvt_bmu, g_bcm963138ref_moca, g_bcm963138ref_bmu, g_bcm963138ref_lte, g_bcm963138ref_plc, 
...
static WLAN_SROM_ENTRY wlan_patch_unique_V2200[] = {
    { 97, 0xfe7d},
    { 98, 0x1df4},
    { 99, 0xf8df},
    { 113,  0xfe95},
...
static WLAN_SROM_ENTRY wlan_patch_unique_R2200H[] = {
    { 97, 0xfe7d},
    { 98, 0x1df4},
    { 99, 0xf8df},
    { 113,  0xfe95},
...
static WLAN_SROM_ENTRY wlan_patch_unique_FV2200[] = {
    { 97, 0xfe7d},
    { 98, 0x1df4},
    { 99, 0xf8df},
    { 113,  0xfe95},
...
static WLAN_SROM_ENTRY wlan_patch_unique_FV2210[] = {
    { 97, 0xfe7d},
    { 98, 0x1df4},
    { 99, 0xf8df},
    { 113,  0xfe95},
...
#if defined(AEI_VDSL_CUSTOMER_NCS) || defined(AEI_VDSL_BCMSDK)
#if defined(_BCM963268_) || defined(CONFIG_BCM963268)
    /* C2000A,V2200H,T2200H,T1200H,V1200W should all use 
     * wlan_patch_unique_C2000A and wlan_patch_common_963168XH
     */
    {"C1000A",      0x6362, 220, wlan_patch_unique_C1000A,        wlan_patch_common_C1000A},
    {"C2000A",      0x6362, 220, wlan_patch_unique_C2000A,        wlan_patch_common_963168XH},
    {"C1000B",      0x6362, 220, wlan_patch_unique_C1000B,        wlan_patch_common_C1000A},
    {"V2200",      0x6362, 220, wlan_patch_unique_V2200,        wlan_patch_common_C1000A},
    {"V2200H",      0x6362, 220, wlan_patch_unique_C2000A,        wlan_patch_common_963168XH},
    {"T2200H",      0x6362, 220, wlan_patch_unique_C2000A,        wlan_patch_common_963168XH},
    {"T1200H",      0x6362, 220, wlan_patch_unique_C2000A,        wlan_patch_common_963168XH},
    /* There is no need to create all these unique wlan patch 
     * below if they all share the same 6 values
     */
    {"R2200H",      0x6362, 220, wlan_patch_unique_R2200H,        wlan_patch_common_C1000A},
    {"FV2200",      0x6362, 220, wlan_patch_unique_FV2200,        wlan_patch_common_C1000A},
    {"FV2210",      0x6362, 220, wlan_patch_unique_FV2210,        wlan_patch_common_C1000A},
    {"FV2250",      0x6362, 220, wlan_patch_unique_C1000A,        wlan_patch_common_C1000A},
#endif
#endif
